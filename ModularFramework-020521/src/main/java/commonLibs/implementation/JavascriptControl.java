...
public class JavascriptControl implements IJavascriptOperations {
	...
	public JavascriptControl(WebDriver driver) {
		jsEngine = (JavascriptExecutor) driver; //Typecasting, setting one variable to another
	}
	...
	public String executeJavaScriptWithReturnValue(String scriptToExecute) throws Exception {
		...
		return jsEngine.executeScript(scriptToExecute).toString(); //jsengine returns object value, to return a string value, we use .toString()
	}
